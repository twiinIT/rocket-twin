...
init = {"g_tank.fuel.weight_p": 20.0, "g_tank.fuel.w_out_max": 1.0, "controller.w_temp": 1.0}

values = {"rocket.stage_1.tank.geom.height": 1.4, "rocket.stage_2.tank.geom.height": 1.2}

...
class TestWings:
    ...
    def test_geometry(self):
        ...
        np.testing.assert_allclose(sys.props.Mass(), 2., atol=10**(-2))
        ...
        np.testing.assert_allclose(sys.props.MatrixOfInertia().Diagonal().X(), 1.01/6, atol=10**(-2))
        np.testing.assert_allclose(sys.props.MatrixOfInertia().Diagonal().Y(), 5/6, atol=10**(-2))
        np.testing.assert_allclose(sys.props.MatrixOfInertia().Diagonal().Z(), 4.01/6, atol=10**(-2))
...
class Ground(System):
    ...
    def setup(self, stations=None):
        ...
        for station in stations:
            ...
            self.add_transient(f"v_{station}", der=f"a_{station}")   #integrate acceleration to get velocity
            self.add_transient(f"r_{station}", der=f"v_{station}")   #integrate velocity to get position

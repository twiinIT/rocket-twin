...
class Rocket(System):
    ...
    def setup(self):
        ...
        self.add_child(RocketGeom('geom', centers=['engine', 'tank'], weights=['weight_eng', 'weight_tank']), pulling=['center'])
        self.add_child(Dynamics('dyn', forces=['thrust'], weights=['weight_eng', 'weight_tank']), pulling=['a'])

...
class Dynamics_2(System):
    def setup(self):
        self.add_outward("a", 1.0, desc="Ball acceleration", unit="m/s**2")
...
class Dynamics(System):
    def setup(self):
        self.add_inward("a0", 2.0, desc="Ball acceleration", unit="m/s**2")
        self.add_outward("a", 1.0, desc="Ball acceleration", unit="m/s**2")
...
class Kinematics(System):
    def setup(self):
        self.add_inward("a", 1.0, desc="Ball acceleration", unit="m/s**2")
        self.add_inward("r_out", 0.0, desc="Ball Position", unit="m")
...
driver.set_scenario(init={"Kin.r": 0.0, "Kin.v": 0.0})

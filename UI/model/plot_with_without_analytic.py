...
with open("3122_0.json", "r") as outfile:
    given_coef = json.load(outfile)

with open("3122_3.json", "r") as outfile:
    analytic_coef = json.load(outfile)

with open("3122_99.json", "r") as outfile:
...
print('\n')
print("Lowest Pressure", np.min(pres_cfd), "Pa")
print('\n')
...
plt.plot(time_cfd, pres_cfd, label = "Model Prediction for CFD coefficient")

...
class RocketPlotter():
    ...
    tex_to_color = {'custom': [1.0, 1.0, 1.0],
                    'motor': [1.0,0.,0.],
    ...
    def plot(self, only_ext=False, opened=True, render='colors'):
        ...
        assert render in available_render, f"Unavailable backend. Valid options are: {', '.join(available_render)}"

        unavailable_textures = ['delrin','bouleau','acrylique','depron_xps','kraft_phenolique','tube_quantum','custom']
